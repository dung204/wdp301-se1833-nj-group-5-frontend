...
import { NodeApi, SlateElement, SlateElementProps } from '@udecode/plate';
import { TCodeBlockElement, formatCodeBlock, isLangSupported } from '@udecode/plate-code-block';
...
function CopyButton({ value, ...props }: CopyButtonProps) {
